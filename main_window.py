...
class ControlPanel(wx.Panel):
    ...
    def onInint(self):
        ...
        local_v_sizer_1.Add(self.pxL ,0,wx.ALIGN_CENTRE)
        local_v_sizer_1.Add(self.pxVal ,0,wx.ALIGN_CENTRE)
        local_v_sizer_1.Add(self.flocalLenL ,0,wx.ALIGN_CENTRE)
        local_v_sizer_1.Add(self.flocalLenVal ,0,wx.ALIGN_CENTRE)
        local_v_sizer_1.Add(self.WaveLenL ,0,wx.ALIGN_CENTRE)
        local_v_sizer_1.Add(self.WaveLenVal ,0,wx.ALIGN_CENTRE)
